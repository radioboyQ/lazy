...
@click.option('--config-path', help='Specify a configuration file to use.', type=click.Path(exists=True, dir_okay=False, resolve_path=True, allow_dash=True), default='/Users/radioboy/lazy.conf')
